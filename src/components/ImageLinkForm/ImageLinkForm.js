...
const ImageLinkForm = ({onInputChange,onFaceDetectSubmit,onCelebDetectSubmit}) =>{
    return(
        <div>
            <p className="f3">
                {'Face recognition web, please insert a photo'}
            </p>
            <div className="center">
                <div className="pa4 form center br3 shadow-5">
                    ...
                    <button className="w-15 grow f4 link ph3 pv2 dib white bg-light-purple" onClick={onCelebDetectSubmit}>Detect Celeb</button>
                </div>
            </div>
        </div>
    );
